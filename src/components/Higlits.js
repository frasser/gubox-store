...
function Higlits() {
    return (
      <div className="px-3">
      <h1 className="text-2xl lg:text-4xl text-gray-700 mt-14 pl-4 ">HIGHLIGHTS</h1>
        <div className="w-full mt-6  ">
        <div className="flex flex-col md:grid  md:grid-rows-2 md:grid-cols-4 md:gap-1 lg:gap-3 py-2 md:py-1.5 lg:p-3 md:h-96 lg:h-screen  ">

        <div className="flex bg-indigo-600  md:order-3 h-60 md:h-auto md:row-span-2 md:col-span-2 lg:row-span-2  lg:col-span-2 rounded-lg shadow-xl mb-2 md:mb-0 ">
            <div className=" flex m-auto align-middle ">
            <p className="text-2xl p-5 lg:text-4xl font-semibold text-white text-center">Gubox Tracking Solutions</p>
            </div>
        </div>

        <div className="flex bg-green-600 md:order-2 h-60 md:h-auto md:row-span-2 md:col-span-1 lg:row-span-2  lg:col-span-1 rounded-lg shadow-xl mb-2 md:mb-0 ">
          <div className=" flex m-auto align-middle ">
            <p className="text-2xl p-5 lg:text-4xl font-semibold text-white text-center">Do you Need a custom Solution?</p>
          </div>
        </div>

        <div className="flex bg-primary-100 md:order-4 h-60 md:h-auto md:row-span-1 md:col-span-1 lg:row-span-1  lg:col-span-1 rounded-lg shadow-xl mb-2 md:mb-0 ">
          <div className=" flex m-auto align-middle ">
            <p className="text-2xl p-5 lg:text-4xl font-semibold text-white text-center">Activation Guide</p> 
            </div>
        </div>

        <div className="flex bg-soft-blue-400 md:order-1 h-60 md:h-auto md:row-span-1 md:col-span-1 lg:row-span-1  lg:col-span-1 rounded-lg shadow-xl  md:mb-0 ">
          <div className=" flex m-auto align-middle ">
            <p className="text-2xl p-5 lg:text-4xl font-semibold text-white text-center">Renewal Suscriptions</p> 
          </div>
        </div>
